...
if("TRUE" STREQUAL "TRUE")
  set(motion_planning_SOURCE_PREFIX /home/pi/multirotor_ws/src/motion_planning)
  set(motion_planning_DEVEL_PREFIX /home/pi/multirotor_ws/devel)
  ...
  set(motion_planning_INSTALL_PREFIX /home/pi/multirotor_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/multirotor_ws/src/motion_planning/${idir}'.  ${_report}")
    endif()
